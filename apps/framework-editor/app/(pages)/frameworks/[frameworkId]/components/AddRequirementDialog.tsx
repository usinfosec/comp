...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter } from '@comp/ui/dialog';
import { Button } from '@comp/ui/button';
import { Input } from '@comp/ui/input';
import { Textarea } from '@comp/ui/textarea';
import { Label } from '@comp/ui/label';
import { useToast } from "@comp/ui/use-toast";
import { addRequirementAction, type AddRequirementActionState } from '../actions/add-requirement-action';
...
export function AddRequirementDialog({ isOpen, onOpenChange, frameworkId, onRequirementAdded }: AddRequirementDialogProps) {
