...
import { CreatePolicySchema, CreatePolicySchemaType } from "../schemas";
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              name="name"
              render={({ field }: { field: ControllerRenderProps<CreatePolicySchemaType, 'name'> }) => (
                <FormItem>
                  <FormLabel>Name</FormLabel>
                  <FormControl>
                    <Input placeholder="e.g., Access Control Policy" {...field} className="rounded-sm" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              control={form.control}
              name="description"
              render={({ field }: { field: ControllerRenderProps<CreatePolicySchemaType, 'description'> }) => (
                <FormItem>
            ...
            />
             <FormField
              control={form.control}
              name="frequency"
              render={({ field }: { field: ControllerRenderProps<CreatePolicySchemaType, 'frequency'> }) => (
                <FormItem>
            ...
            />
             <FormField
              control={form.control}
              name="department"
              render={({ field }: { field: ControllerRenderProps<CreatePolicySchemaType, 'department'> }) => (
                <FormItem>
            ...
            />
            <DialogFooter>
              <Button type="button" variant="ghost" onClick={() => onOpenChange(false)} className="rounded-sm">Cancel</Button>
