    ...
    return (
      <div className="flex items-center justify-center">
        <span
          ...
          className={cn(
            "relative font-mono pointer-events-none text-center text-[6rem] font-bold leading-none before:bg-gradient-to-b before:from-neutral-700/70 before:to-neutral-800/30 before:to-80% before:bg-clip-text before:text-transparent before:content-[var(--text)] after:absolute after:inset-0 after:bg-neutral-600/70 after:bg-clip-text after:text-transparent after:mix-blend-lighten after:content-[var(--text)] after:[text-shadow:0_1px_0_black]",
            className
          )}
          {...props}
        />
