...
import type { ClientMessage, User } from "@/actions/ai/types";
...
export function Chat({
  ...
  submitMessage: (message: ClientMessage[]) => void;
  user: User;
  onNewChat: () => void;
  input: string;
  ...
  const onSubmit = async (input: string) => {
    ...
    submitMessage([...messages, responseMessage]);
  };
