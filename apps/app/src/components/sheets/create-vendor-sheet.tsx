...
import { CreateVendor } from "../forms/vendors/create-vendor-form";
...
export function CreateVendorSheet() {
      ...
      <Sheet open={isOpen} onOpenChange={handleOpenChange}>
        <SheetContent stack>
          <SheetHeader className="mb-8 flex justify-between items-center flex-row">
            <SheetTitle>{t("risk.vendor.actions.create")}</SheetTitle>
            <Button
              size="icon"
              variant="ghost"
  ...
  return (
    <Drawer open={isOpen} onOpenChange={handleOpenChange}>
      <DrawerTitle hidden>{t("risk.vendor.actions.create")}</DrawerTitle>
