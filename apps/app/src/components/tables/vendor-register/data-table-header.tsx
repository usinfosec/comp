      ...
      <TableRow className="h-[45px] hover:bg-transparent">
        {isVisible("name") && (
          <TableHead className="min-w-[120px] px-3 md:px-4 py-2">
            ...
            >
              <span>{t("risk.vendor.table.name")}</span>
        ...
        {isVisible("status") && (
          <TableHead className="min-w-[120px] px-3 md:px-4 py-2">
            ...
            >
              <span>{t("risk.vendor.table.status")}</span>
        ...
        {isVisible("owner") && (
          <TableHead className="min-w-[120px] px-3 md:px-4 py-2 hidden sm:table-cell">
            <Button
              className="p-0 hover:bg-transparent space-x-2"
              variant="ghost"
              onClick={() => createSortQuery("owner")}
            >
              <span>{t("risk.vendor.table.owner")}</span>
              {"owner" === column && value === "asc" && <ArrowDown size={16} />}
              {"owner" === column && value === "desc" && <ArrowUp size={16} />}
            </Button>
          </TableHead>
        )}
      </TableRow>
