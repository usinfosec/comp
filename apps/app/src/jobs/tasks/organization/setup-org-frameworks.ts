import { RequirementType, type Policy, type User } from "@bubba/db/types";
import type { InputJsonValue } from "@prisma/client/runtime/library";
import { db } from "@bubba/db";
import { logger, schemaTask } from "@trigger.dev/sdk/v3";
import { z } from "zod";

export const setupOrgFrameworksTask = schemaTask({
	id: "setup-org-frameworks",
	...
	run: async ({ organizationId, frameworkIds, userId }) => {
