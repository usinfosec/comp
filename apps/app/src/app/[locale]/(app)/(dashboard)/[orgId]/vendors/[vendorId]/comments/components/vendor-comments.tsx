...
import type { Vendor, VendorComment, User } from "@bubba/db/types";
...
import { VendorCommentSheet } from "./vendor-comment-sheet";

export function VendorComments({
  vendor,
  users,
}: {
  vendor: Vendor & { comments: VendorComment[] };
  users: User[];
}) {
