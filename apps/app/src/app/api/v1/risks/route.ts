 ...
 * - probability: number - The probability score (0-10) (optional, defaults to 0)
 * - impact: number - The impact score (0-10) (optional, defaults to 0)
 * - residual_probability: number - The residual probability score (0-10) (optional, defaults to 0)
 * - residual_impact: number - The residual impact score (0-10) (optional, defaults to 0)
