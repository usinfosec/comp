export default {
  ...
  common: {
    ...
    attachments: {
      ...
      drop_description:
        "Déposez des fichiers ici ou cliquez pour choisir des fichiers sur votre appareil.",
    ...
    register: {
      ...
      empty: {
        no_risks: {
          ...
          description:
            "Suivez et évaluez les risques, créez et assignez des tâches d'atténuation à votre équipe, et gérez votre registre des risques dans une interface simple.",
        },
  ...
  evidence: {
    ...
    description:
      "Gérez et suivez les tâches de preuve pour vos exigences de conformité.",
