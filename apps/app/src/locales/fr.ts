export default {
		...
		upload: {
			fileUpload: {
				...
				dragDropOrClickToSelect:
					"Faites glisser et déposez ou cliquez pour sélectionner le fichier",
			...
			fileCard: {
				...
				deleteFileConfirmDescription:
					"Cette action ne peut pas être annulée. Le fichier sera définitivement supprimé.",
			},
			fileSection: {
	...
	policies: {
		...
		overview: {
			...
			form: {
				...
				signature_requirement_placeholder:
					"Sélectionner l'exigence de signature",
			},
		},
		new: {
	...
	settings: {
		...
		api_keys: {
			title: "Clés API",
			description:
				"Gérez les clés API pour un accès programmatique aux données de votre organisation.",
			list_title: "Clés API",
			list_description:
				"Les clés API permettent un accès sécurisé aux données de votre organisation via notre API.",
			create: "Nouvelle clé API",
			create_title: "Nouvelle clé API",
			create_description:
				"Créez une nouvelle clé API pour un accès programmatique aux données de votre organisation.",
			created_title: "Clé API créée",
			created_description:
				"Votre clé API a été créée. Assurez-vous de la copier maintenant car vous ne pourrez plus la voir.",
			name: "Nom",
			name_label: "Nom",
			...
			api_key: "Clé API",
			save_warning:
				"Cette clé ne sera affichée qu'une seule fois. Assurez-vous de la copier maintenant.",
			copied: "Clé API copiée dans le presse-papiers",
			close_confirm:
				"Êtes-vous sûr de vouloir fermer ? Vous ne pourrez plus voir cette clé API.",
			revoke_confirm:
				"Êtes-vous sûr de vouloir révoquer cette clé API ? Cette action ne peut pas être annulée.",
			...
			security_note:
				"Les clés API fournissent un accès complet aux données de votre organisation. Gardez-les sécurisées et renouvelez-les régulièrement.",
		...
		team: {
			...
			invitations: {
				...
				description:
					"Utilisateurs qui ont été invités mais n'ont pas encore accepté",
				empty: {
					no_organization: {
						title: "Aucune organisation",
						description: "Vous ne faites partie d'aucune organisation",
				...
				toast: {
					...
					resend_unexpected:
						"Une erreur inattendue s'est produite lors de l'envoi de l'invitation",
					...
					revoke_unexpected:
						"Une erreur inattendue s'est produite lors de la révocation de l'invitation",
				},
			},
			invite: {
				title: "Inviter un membre de l'équipe",
				description:
					"Envoyer une invitation à un nouveau membre de l'équipe pour rejoindre votre organisation",
				form: {
					email: {
						label: "E-mail",
			...
			member_actions: {
				...
				role_dialog: {
					...
					role_descriptions: {
						admin:
							"Les administrateurs peuvent gérer les membres de l'équipe et les paramètres.",
						member:
							"Les membres peuvent utiliser toutes les fonctionnalités mais ne peuvent pas gérer les membres de l'équipe.",
						viewer:
							"Les spectateurs ne peuvent que visualiser le contenu sans apporter de modifications.",
					},
					cancel: "Annuler",
				...
				toast: {
					...
					remove_unexpected:
						"Une erreur inattendue s'est produite lors de la suppression du membre",
					...
					update_role_unexpected:
						"Une erreur inattendue s'est produite lors de la mise à jour du rôle du membre",
				},
			},
		},
	},
			...
			role_dialog: {
				...
				role_descriptions: {
					...
					member:
						"Les membres peuvent utiliser toutes les fonctionnalités mais ne peuvent pas gérer les membres de l'équipe.",
					viewer:
						"Les spectateurs peuvent uniquement visualiser le contenu sans apporter de modifications.",
				},
				cancel: "Annuler",
				update: "Mettre à jour le rôle",
			},
