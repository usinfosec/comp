...
export const soc2Requirements: Requirements = {
	CC1: {
	...
	A1: {
		...
		code: "A1",
		description:
			"This criterion ensures that systems are available for operation and use as committed or agreed.",
	},
	C1: {
		name: "C1: Data Integrity",
		code: "C1",
		description:
			"This criterion ensures that data is accurate, complete, and consistent.",
	},
	PI1: {
