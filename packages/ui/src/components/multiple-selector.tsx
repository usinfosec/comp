  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'border-border min-h-10 border text-sm',
            {
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="bg-popover text-popover-foreground border-border animate-in absolute top-1 z-10 max-h-[200px] w-full overflow-auto border shadow-md outline-hidden"
              onMouseLeave={() => {
