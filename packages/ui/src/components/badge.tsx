...
const badgeVariants = cva(
	"inline-flex items-center rounded-xs border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 relative",
	{
		variants: {
			variant: {
				default:
				...
				tag: "font-mono text-muted-foreground bg-accent text-[10px] dark:bg-accent border-none rounded-xs hover:bg-accent/70",
				marketing:
