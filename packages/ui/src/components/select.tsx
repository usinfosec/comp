...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-input bg-background flex h-9 w-full items-center justify-between rounded-sm border px-3 py-2 text-sm transition-colors',
      'placeholder:text-muted-foreground focus:ring-ring',
      'focus:ring-1 focus:ring-offset-0 focus:outline-hidden',
