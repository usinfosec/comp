  ...
  "inline-flex items-center justify-center text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 overflow-hidden relative",
  {
    variants: {
      variant: {
        ...
        action:
          "flex items-center gap-2 whitespace-nowrap border border bg-transparent text-accent-foreground hover:bg-accent/90 before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-2 before:bg-[#00DC73]",
      },
      size: {
