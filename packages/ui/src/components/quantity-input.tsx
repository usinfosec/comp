	...
	return (
		...
		>
			...
			<div className="relative grid items-center justify-items-center text-center">
				<input
					ref={inputRef}
					className="flex w-8 text-center transition-colors file:text-base file:font-medium placeholder:text-muted-foreground focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 p-0 border-0 h-6 text-xs bg-transparent! border-b border-transparent focus:border-border [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [-moz-appearance:textfield]"
