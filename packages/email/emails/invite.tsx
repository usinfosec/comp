...
export const InviteEmail = ({ email, teamName, inviteCode }: Props) => {
	...
	const inviteLink = isLocal
		? `http://localhost:3000/auth?inviteCode=${inviteCode}`
		: `https://app.trycomp.ai/auth?inviteCode=${inviteCode}`;
				...
				<Body className="bg-[#fff] my-auto mx-auto font-sans">
					...
					>
						...
						<Heading className="mx-0 my-[30px] p-0 text-[24px] font-normal text-[#121212] text-center">
							Join <strong>{teamName}</strong> on <strong>Comp AI</strong>
						</Heading>
