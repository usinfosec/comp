...
export const WelcomeEmail = ({ fullName = "Viktor Hofte" }: Props) => {
  ...
  const text = `Hi ${firstName}, Welcome to Bubba! I'm Lewis, one of the founders. It's really important to us that you have a great experience ramping up.`;
        ...
        <Body className="bg-[#fff] my-auto mx-auto font-sans">
          ...
          >
            ...
            <Text className="text-[#121212]">
              Welcome to Comp AI! I'm Lewis, one of the founders.
              <br />
              <br />
              We've been working on Comp AI for the past months, and during this
